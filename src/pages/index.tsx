...
export default function Home({ latestEpisodes, allEpisodes }: HomeProps) {
  ...
  return (
    <div className={styles.homepage}>
      ...
      //injeta na tag head do document
      <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('episodes', {
    params: {
      //adiciona nos parametros da url
      // 12 episodios
      _limit: 12,
      // organizar por data de publicação
      _sort: 'published_at',
      //em order decrescente
      _order: 'desc'
    }
  })

  // manipular o dado como quer que ele seja renderizado, no caso alteramos o formato da data
